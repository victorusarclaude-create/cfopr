...
function mergeState(A,B,only){
  ...
  if(has('jn')){ const a=(A.jn||{}).c||{}, b=(B.jn||{}).c||{}; O.jn={c:{}}; new Set(Object.keys(a).concat(Object.keys(b))).forEach(k=>{ const x=a[k]||{}, y=b[k]||{}; O.jn.c[k]={p:maxN(x.p,y.p),d:maxN(x.d,y.d),st:maxN(x.st,y.st),w:[...new Set([].concat(y.w||[],x.w||[]))].slice(-30)}; }); }
